...
const copyRight =
  "Copyright © Travis-hjs.github.io All Rights Reserved 请使用 Google Chrome、Microsoft Edge、360浏览器、非 IE 等浏览器";
      ...
      <div class="form-box">
        <div class="login-form">
          ...
          <div class="tips f-vertical" v-for="(item, index) in tipList" :key="index">
            <button class="the-btn mini green" v-ripple v-copy="item" :disabled="loading">
              点击复制
            </button>
            <div class="tips_text f1">账号: {{ item }}; 密码: 随便填</div>
            <button
              class="the-btn mini blue"
              v-ripple
              :disabled="loading"
              @click="setLoginInfo(item)"
            >
              一键登录
            </button>
          </div>
